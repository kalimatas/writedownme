...
app.add_url_rule('/delete/<string:hash>', view_func=views.delete_idea, methods=['GET'])
app.add_url_rule('/edit/<string:hash>', view_func=views.edit_idea, methods=['GET', 'POST'])
